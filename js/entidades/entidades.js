 ...
 *********************************************************************************************/
    ...
    function habEntidad()
		{
			/*
			 * Esta función habilita los controles del formulario de entidades.
			 */
        			...
        			if(e.target.id.substring(0,10) == "ent_buscar")
        				{
        					...
        					document.getElementById('pgentidad').value = document.getElementById('busentidad').value.toString();
        					document.getElementById('pgidtentidad').value = document.getElementById('busidtentidad').value.toString();
        					cargar('./php/frontend/entidades/catEntidades.php','?busentidad='+document.getElementById('busentidad').value.toString()+'&busidentidad='+document.getElementById('busidtentidad').value.toString(),'busRes');
        					}
        			});                 
    		});
    				            			...
    				            			if(result)
    				            				{
    				            					...
    				            					cargar('./php/backend/dal/entidades/dalEntidades.class.php','?id='+e.target.id.substring(11)+'&accion=EdRS','sandbox');
    				            					}			            					
    				            			}
    			            		});
        					}
    				...
    				if(e.target.id == "ent_Previous_10")
    					{
    						...
    						cargar('./php/frontend/entidades/catEntidades.php','?busentidad='+document.getElementById('pgentidad').value.toString()+'&busidentidad='+document.getElementById('pgidtentidad').value.toString()+'&pagina='+document.getElementById('pagina').value.toString(),'busRes');
    						}
    				});                 
			});
    				            	...
    				            	callback: function (result)
    				            		{
    				            			if(result)
    				            				{
    				            					//EL USUARIO DECIDE BORRAR EL REGISTRO.
    				            					cargar('./php/backend/dal/entidades/dalEntidades.class.php','?id='+document.getElementById('idEntidad').value.toString()+'&accion=EdRS','sandbox');
    				            					}			            					
    				            			}
    			            		});
    			    		}
    				            			...
    				            			if(result)
    				            				{
    				            					...
    				            					guardarEntidad('./php/backend/dal/entidades/dalEntidades.class.php','?id='+document.getElementById('idEntidad').value.toString()+'&entidad='+document.getElementById('Entidad').value.toString()+'&idtentidad='+document.getElementById('idTEntidad').value.toString()+'&status='+document.getElementById('Status').value.toString()+'&accion=CoER');
    				            					}			            					
    				            			}
    				        		});			        		
    						}
