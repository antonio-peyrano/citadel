...
DELETE FROM opRelUsrCli;
DELETE FROM opResParEva;
DELETE FROM opSolicitudes;
DELETE FROM relUsrEmp;

ALTER TABLE catClientes AUTO_INCREMENT = 1;
...
ALTER TABLE opRelUsrCli AUTO_INCREMENT = 1;
ALTER TABLE opResParEva AUTO_INCREMENT = 1;
ALTER TABLE opSolicitudes AUTO_INCREMENT = 1;
ALTER TABLE relUsrEmp AUTO_INCREMENT = 1;

INSERT INTO `catModulos` (`idModulo`, `Modulo`, `URL`, `Status`) VALUES
(1, 'Usuarios', '/citadel/php/frontend/usuarios/sysadmin/busUsuarios.php', 0),
(2, 'Configuraciones', '/citadel/php/frontend/configuracion/busConfiguraciones.php', 0),
(3, 'Clientes', '/citadel/php/frontend/clientes/busClientes.php', 0),
(4, 'Solicitudes', '/citadel/php/frontend/solicitudes/busSolicitudes.php', 0),
(5, 'Cedulas', '/citadel/php/frontend/instrumentos/cedulas/busCedulas.php', 0),
(6, 'Entidades', '/citadel/php/frontend/entidades/busEntidades.php', 0),
(7, 'Colonias', '/citadel/php/frontend/colonias/busColonias.php', 0),
(8, 'Factores', '/citadel/php/frontend/instrumentos/factores/busFactores.php', 0),
(9, 'Escalas', '/citadel/php/frontend/instrumentos/escalas/busEscalas.php', 0),
(10, 'Evaluaciones', '/citadel/php/frontend/instrumentos/evaluaciones/busEvaluaciones.php', 0);
...
(1, 1, 'sysadmin', '1OXW3t7Q', 'antonio.peyrano@live.com.mx', 'Su primera mascota', 'motis', 0);
...
INSERT INTO `catColonias` (`idColonia`, `Colonia`, `cp`, `Ciudad`, `Estado`, `Status`) VALUES
