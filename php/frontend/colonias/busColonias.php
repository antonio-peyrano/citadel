 ...
 */
    ...
    include_once ($_SERVER['DOCUMENT_ROOT']."/citadel/php/backend/bl/colonias/colonias.class.php"); //Se carga la referencia de la clase para manejo de la entidad usuarios.
                    ...
                    $HTML = '
                            ...
                            <div id= "divBusqueda">
                                <table class="queryTable" colspan= "7">
                                    <tr><td class= "queryRowsnormTR" width ="180">Por nombre: </td><td class= "queryRowsnormTR" width= "250"><input type= "text" id= "buscolonia"></td><td rowspan= "2"><img id="'.$this->Sufijo.'buscar" align= "left" src= "./img/grids/view.png" width= "25" height= "25" alt="Buscar"/></td></tr>
                                    <tr><td class= "queryRowsnormTR">Por codigo postal: </td><td class= "queryRowsnormTR"><input type= "text" id= "buscp"></td><td></td></tr>
                                </table>
                            </div>';
            ...
            if($objUsrCtrl->validarCredenciales($idUsuario, $Modulo)!='')
                {
                    ...
                    echo '  <html>
                                <center>'.$objBusColonias->drawUI().'</center><br>';
