 ...
 */
    ...
    include_once ($_SERVER['DOCUMENT_ROOT']."/citadel/php/backend/bl/instrumentos/factores/factores.class.php"); //Se carga la referencia de la clase para manejo de la entidad usuarios.
