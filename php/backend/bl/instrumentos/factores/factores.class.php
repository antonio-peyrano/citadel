    ...
    class factores
        {
            ...
            private $Factor = "";
            private $Tipo = "";
            private $Consulta = "SELECT idFactor, opCedulas.Folio AS Cedula, Factor, IF(Tipo='1','Interno','Externo') AS Tipo, opFactores.Status FROM (opFactores INNER JOIN opCedulas ON opFactores.idCedula = opCedulas.idCedula) WHERE opFactores.Status=0";
