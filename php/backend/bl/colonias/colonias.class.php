    ...
    class colonias
        {
             ...
             * y funcionalidades de la interfaz del modulo de colonias.
             */
            
            //ATRIBUTOS APLICABLES AL MODULO catColonias.php
            ...
            private $Ciudad = "";
            private $Estado = "";
            private $Consulta = "SELECT idColonia, Colonia, cp, Ciudad, Estado, Status FROM catColonias WHERE Status=0";
            //FIN DE DECLARACION DE ATRIBUTOS APLICABLES AL MODULO catColonias.php
            
            //ATRIBUTOS APLICABLES AL MODULO opColonias.php
            private $idColonia = NULL;
            private $cntView = 0;
            //FIN DE DECLARACION DE ATRIBUTOS APLICABLES AL MODULO opColonias.php
            ...
            //PROCEDIMIENTOS APLICABLES AL MODULO catColonias.php
            public function getColonia()
                {
                    /*
                     * Esta funcion retorna el valor del nombre de colonia.
                     */
                    return $this->Colonia;
                    }
            ...
            public function getCP()
                {
                    /*
                     * Esta funcion retorna el valor de codigo postal.
                     */
                    return $this->cp;
                    }
            ...
            public function setCatParametros($Colonia, $cp)
                {
                    /*
            ...
            public function evaluaCondicion()
                {
                    ...
                    if(!empty($this->getColonia()))
                        {
                            $this->Condicionales = ' AND Colonia LIKE \'%'.$this->getColonia().'%\'';
                            }
                            
                    if(!empty($this->getCP()))
                        {

                            $this->Condicionales= $this->Condicionales.' AND cp LIKE \'%'.$this->getCP().'%\'';
                            }
                                                        
                    return $this->Condicionales;                            
                    }                    
            //FIN DE DECLARACION DE PROCEDIMIENTOS APLICABLES AL MODULO catColonias.php
            
            //PROCEDIMIENTOS APLICABLES AL MODULO opColonias.php.
            public function getRegistro($idRegistro)
                {
                    ...
                    $Consulta= 'SELECT idColonia, Colonia, cp, Ciudad, Estado, Status FROM catColonias WHERE idColonia='.$idRegistro; //Se establece el modelo de consulta de datos.
                    $dsColonia = $objConexion -> conectar($Consulta); //Se ejecuta la consulta.
                    
                    $RegColonia = @mysqli_fetch_array($dsColonia,MYSQLI_ASSOC);//Llamada a la funcion de carga de registro de usuario.
                    return $RegColonia;
                    }                    
            ...
            //FIN DE DECLARACION DE PROCEDIMIENTOS APLICABLES AL MODULO opColonias.php            
            }
?>